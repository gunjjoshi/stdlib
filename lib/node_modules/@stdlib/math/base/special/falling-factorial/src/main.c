...
* ## Notice
*
* The following copyright and license were part of the original implementation available as part of [Boost Library]{@link https://www.boost.org/doc/libs/1_86_0/boost/math/special_functions/factorials.hpp}. The implementation follows the original, but has been modified for JavaScript.
*
* ```text
