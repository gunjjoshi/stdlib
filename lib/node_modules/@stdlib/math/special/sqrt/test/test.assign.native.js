...
tape( 'the function computes the principal square root for each element in an ndarray for each element in an ndarray and assigns the results to a provided output ndarray', opts, function test( t ) {
	var expected;
	var out;
	var x;
	var y;
