...
"""Benchmark pure Python vectorized erf using list comprehension."""
...
def main():
    ...
    while p <= MAX:
        ...
        setup = "from math import erf; import random;"
        setup += "x = [random.uniform(-1.0, 1.0) for _ in range("+str(n)+")];"
        stmt = "y = [erf(xi) for xi in x]"
