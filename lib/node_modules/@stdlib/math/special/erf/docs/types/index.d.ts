...
interface UnaryFunction {
	/**
	* Computes the error function for each element in an ndarray.
	*
	...
	*/
	...
	/**
	* Compute the error function for each element in an ndarray. for each element in an ndarray and assigns results to a provided output ndarray.
	*
	* @param x - input ndarray
