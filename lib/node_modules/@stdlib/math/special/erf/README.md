...
> Compute the [error function][@stdlib/math/base/special/erf] for each element in an [ndarray][@stdlib/ndarray/ctor].
...
```javascript
var erf = require( '@stdlib/math/special/erf' );
```

#### erf( x\[, options] )

Computes the [error function][@stdlib/math/base/special/erf] for each element in an [ndarray][@stdlib/ndarray/ctor].

```javascript
var ndarray2array = require( '@stdlib/ndarray/to-array' );
var array = require( '@stdlib/ndarray/array' );

var x = array( [ [ -3.71, 2.48 ], [ -1.96, 0.83 ] ] );
var y = erf( x );
// returns <ndarray>

var arr = ndarray2array( y );
// returns [ [ ~-1, ~1 ], [ ~-0.99, ~0.76 ] ]
```
...
Computes the [error function][@stdlib/math/base/special/erf] for each element in an [ndarray][@stdlib/ndarray/ctor] and assigns results to a provided output [ndarray][@stdlib/ndarray/ctor].
...
var arr = ndarray2array( out );
// returns [ [ [ ~-1, ~1 ], [ ~-0.99, ~0.76 ] ], [ [ ~-1, ~1 ], [ ~-0.99, ~0.76 ] ] ]
```
