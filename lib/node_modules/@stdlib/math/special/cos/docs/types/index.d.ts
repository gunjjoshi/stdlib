...
interface UnaryFunction {
	/**
	* Computes the cosine for each element in an ndarray.
	*
	...
	*/
	...
	/**
	* Compute the cosine for each element in an ndarray. for each element in an ndarray and assigns results to a provided output ndarray.
	*
	* @param x - input ndarray
