...
"""Benchmark pure Python vectorized cos using list comprehension."""
...
def main():
    ...
    while p <= MAX:
        n = 10**p
        p += 1
        name = ":vectorized=true,method=list_comprehension,len="+str(n)
        setup = "from math import cos; import random;"
        setup += "x = [random.uniform(-3.14159, 3.14159) for _ in range("+str(n)+")];"
        stmt = "y = [cos(xi) for xi in x]"
