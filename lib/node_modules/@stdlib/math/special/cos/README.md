...
> Compute the [cosine][@stdlib/math/base/special/cos] for each element in an [ndarray][@stdlib/ndarray/ctor].
...
```javascript
var cos = require( '@stdlib/math/special/cos' );
```

#### cos( x\[, options] )

Computes the [cosine][@stdlib/math/base/special/cos] for each element in an [ndarray][@stdlib/ndarray/ctor].

```javascript
var ndarray2array = require( '@stdlib/ndarray/to-array' );
var array = require( '@stdlib/ndarray/array' );

var x = array( [ [ 64, 27 ], [ 0, 0.1 ] ] );
var y = cos( x );
// returns <ndarray>

var arr = ndarray2array( y );
// returns [ [ ~0.39, ~-0.29 ], [ ~1, ~1 ] ]
```
...
Computes the [cosine][@stdlib/math/base/special/cos] for each element in an [ndarray][@stdlib/ndarray/ctor] and assigns results to a provided output [ndarray][@stdlib/ndarray/ctor].
...
var arr = ndarray2array( out );
// returns [ [ [ ~0.39, ~-0.29 ], [ ~1, ~1 ] ], [ [ ~0.39, ~-0.29 ], [ ~1, ~1 ] ] ]
```
