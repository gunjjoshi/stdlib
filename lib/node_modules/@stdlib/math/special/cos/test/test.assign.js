...
var base = require( '@stdlib/math/base/special/cos' );
var cos = require( './../lib/main.js' );
...
tape( 'attached to the main export is an `assign` method', function test( t ) {
	t.strictEqual( typeof cos.assign, 'function', 'returns expected value' );
	t.end();
});
...
tape( 'the function computes the cosine for each element in an ndarray for each element in an ndarray and assigns the results to a provided output ndarray', function test( t ) {
	var expected;
	var out;
	var x;
	var y;

	x = random( [ 5, 5 ], -10.0, 10.0, {
		'dtype': 'float64'
	});
	y = zeros( getShape( x ), {
		'dtype': 'float64'
